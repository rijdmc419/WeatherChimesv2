...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 61.0, 40.299987999999999, 168.061855554580688, 81.680411100387573 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 67.299987999999999, 47.0, 28.0 ],
					"rounded" : 15.0,
					"text" : "Stop",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 142.061855554580688, 189.011326877677902, 87.0, 22.0 ],
					"text" : "birds_of_paradice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.5, 472.0, 59.0, 22.0 ],
					"text" : "r to_node"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 368.0, 61.0, 22.0 ],
					"text" : "s to_node"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 73.0, 515.0, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 142.061855554580688, 214.711338877677917, 87.0, 22.0 ],
					"text" : "PracticeChimes"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 11.561855554580688, 189.011326877677902, 128.0, 21.0 ],
					"text" : "Host Name",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 614.0, 301.0, 41.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.561855554580688, 214.711338877677917, 128.0, 21.0 ],
					"text" : "Group",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 97.299987999999999, 47.0, 28.0 ],
					"rounded" : 15.0,
					"text" : "Clear",
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textovercolor" : [ 0.317647, 0.654902, 0.976471, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.833344000000011, 427.0, 203.0, 77.0 ],
					"text" : "connect mqtt://io.adafruit.com birds_of_paradice aio_YvTJ96zLSB6nuej2U8xgnXx6fW8D birds_of_paradice PracticeChimes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 265.833344000000011, 377.0, 226.0, 22.0 ],
					"text" : "pak connect mqtt://io.adafruit.com s s s s"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 37.299987999999999, 47.0, 28.0 ],
					"rounded" : 15.0,
					"text" : "Send",
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textovercolor" : [ 0.317647, 0.654902, 0.976471, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.5, 12.833373999999999, 82.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 7.0, 228.0, 25.0 ],
					"text" : "AIO Setup",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1,
					"varname" : "patch_title"
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 142.061855554580688, 161.711338877677917, 87.0, 22.0 ],
					"text" : "aio_YvTJ96zLSB6nuej2U8xgnXx6fW8D"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.833344000000011, 272.0, 62.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.561855554580688, 136.011326877677902, 128.0, 21.0 ],
					"text" : "Username",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.833344000000011, 272.0, 51.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.561855554580688, 161.711338877677917, 128.0, 21.0 ],
					"text" : "AIO Key",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 142.061855554580688, 136.011326877677902, 87.0, 22.0 ],
					"text" : "birds_of_paradice"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.061855554580688, 127.711338877677917, 231.0, 114.0 ],
					"proportion" : 0.39
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 242.0, 245.680411100387573 ],
					"proportion" : 0.39,
					"varname" : "background"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "example.js",
				"bootpath" : "~/Documents/Jonah URSA Project/MQTT Practice",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
